...
exports.exit = function (code) {
    ...
    if (process[Symbol.for('lab')]
        && (typeof process[Symbol.for('lab')].cov === 'function')) {

        // We are in a child process, send any coverage information
        // to the parent before we exit
        return process[Symbol.for('lab')].cov(() => {
...
exports.execute = function (scripts, options, reporter, callback) {
    ...
    scripts = [].concat(scripts).filter((script) => {
