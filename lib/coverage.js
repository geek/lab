...
internals.instrument = function (filename) {
    ...
    if (typeof global.__$$labCov === 'undefined') {
        const markTestCov = (name, line) => {

            if (typeof global.__$$labTest === 'undefined') {
                return;
            }

            global.__$$labTest.cov = global.__$$labTest.cov || { files: {} };
            global.__$$labTest.cov.files[name] = global.__$$labTest.cov.files[name] || [];
            global.__$$labTest.cov.files[name].push(line);
        };
